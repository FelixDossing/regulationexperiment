(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsAllocationInfoAllocationInfoComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsAllocationAllocationComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsDataDataComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsNewpasswordNewpasswordComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsRegulationRegulationComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsSessionSessionComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsSurveyoneSurveyoneComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsSurveytwoSurveytwoComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsWorkoneWorkoneComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsWorktwoWorktwoComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_validate_service__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(
    /*! ./services/validate.service */
    "./src/app/services/validate.service.ts");
    /* harmony import */


    var _services_admin_service__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(
    ...
    var _services_interaction_service__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(
    ...
    var _guards_admin_guard__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(
    /*! ./guards/admin.guard */
    "./src/app/guards/admin.guard.ts");
    /* harmony import */


    var _components_login_login_component__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(
    /*! ./components/login/login.component */
    "./src/app/components/login/login.component.ts");
    /* harmony import */


    var _components_register_register_component__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(
    /*! ./components/register/register.component */
    "./src/app/components/register/register.component.ts");
    /* harmony import */


    var _components_navbar_navbar_component__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(
    /*! ./components/navbar/navbar.component */
    "./src/app/components/navbar/navbar.component.ts");
    /* harmony import */


    var _components_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(
    /*! ./components/dashboard/dashboard.component */
    "./src/app/components/dashboard/dashboard.component.ts");
    /* harmony import */


    var _components_admin_admin_component__WEBPACK_IMPORTED_MODULE_41__ = __webpack_require__(
    /*! ./components/admin/admin.component */
    "./src/app/components/admin/admin.component.ts");
    /* harmony import */


    var _components_newpassword_newpassword_component__WEBPACK_IMPORTED_MODULE_42__ = __webpack_require__(
    /*! ./components/newpassword/newpassword.component */
    "./src/app/components/newpassword/newpassword.component.ts");
    /* harmony import */


    var _components_instructions_instructions_component__WEBPACK_IMPORTED_MODULE_43__ = __webpack_require__(
    /*! ./components/instructions/instructions.component */
    "./src/app/components/instructions/instructions.component.ts");
    /* harmony import */


    var _components_session_session_component__WEBPACK_IMPORTED_MODULE_44__ = __webpack_require__(
    /*! ./components/session/session.component */
    "./src/app/components/session/session.component.ts");
    /* harmony import */


    var _components_allocation_allocation_component__WEBPACK_IMPORTED_MODULE_45__ = __webpack_require__(
    /*! ./components/allocation/allocation.component */
    "./src/app/components/allocation/allocation.component.ts");
    /* harmony import */


    var _components_regulation_regulation_component__WEBPACK_IMPORTED_MODULE_46__ = __webpack_require__(
    /*! ./components/regulation/regulation.component */
    "./src/app/components/regulation/regulation.component.ts");
    /* harmony import */


    var _components_work_work_component__WEBPACK_IMPORTED_MODULE_47__ = __webpack_require__(
    /*! ./components/work/work.component */
    "./src/app/components/work/work.component.ts");
    /* harmony import */


    var _components_workone_workone_component__WEBPACK_IMPORTED_MODULE_48__ = __webpack_require__(
    /*! ./components/workone/workone.component */
    "./src/app/components/workone/workone.component.ts");
    /* harmony import */


    var _components_worktwo_worktwo_component__WEBPACK_IMPORTED_MODULE_49__ = __webpack_require__(
    /*! ./components/worktwo/worktwo.component */
    "./src/app/components/worktwo/worktwo.component.ts");
    /* harmony import */


    var _components_surveyone_surveyone_component__WEBPACK_IMPORTED_MODULE_50__ = __webpack_require__(
    /*! ./components/surveyone/surveyone.component */
    "./src/app/components/surveyone/surveyone.component.ts");
    /* harmony import */


    var _components_surveytwo_surveytwo_component__WEBPACK_IMPORTED_MODULE_51__ = __webpack_require__(
    /*! ./components/surveytwo/surveytwo.component */
    "./src/app/components/surveytwo/surveytwo.component.ts");
    /* harmony import */


    var _components_allocation_info_allocation_info_component__WEBPACK_IMPORTED_MODULE_52__ = __webpack_require__(
    /*! ./components/allocation-info/allocation-info.component */
    "./src/app/components/allocation-info/allocation-info.component.ts");
    /* harmony import */


    var _components_data_data_component__WEBPACK_IMPORTED_MODULE_53__ = __webpack_require__(
    /*! ./components/data/data.component */
    "./src/app/components/data/data.component.ts"); // import { AppRoutingModule } from './app-routing.module';


    const appRoutes = [{
      path: 'login',
      component: _components_login_login_component__WEBPACK_IMPORTED_MODULE_37__["LoginComponent"]
    }, {
      path: 'newpassword/:resetcode',
      component: _components_newpassword_newpassword_component__WEBPACK_IMPORTED_MODULE_42__["NewpasswordComponent"]
    }, {
      path: 'register',
      component: _components_register_register_component__WEBPACK_IMPORTED_MODULE_38__["RegisterComponent"]
    }, {
      path: '',
      ...
      path: 'dashboard',
      component: _components_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_40__["DashboardComponent"],
      canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_35__["AuthGuard"]]
    }, {
      path: 'instructions',
      component: _components_instructions_instructions_component__WEBPACK_IMPORTED_MODULE_43__["InstructionsComponent"],
      canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_35__["AuthGuard"]]
    }, {
      path: 'admin',
      component: _components_admin_admin_component__WEBPACK_IMPORTED_MODULE_41__["AdminComponent"],
      canActivate: [_guards_admin_guard__WEBPACK_IMPORTED_MODULE_36__["AdminGuard"]]
    }, {
      path: 'session',
      component: _components_session_session_component__WEBPACK_IMPORTED_MODULE_44__["SessionComponent"],
      canActivate: [_guards_admin_guard__WEBPACK_IMPORTED_MODULE_36__["AdminGuard"]]
    }, {
      path: 'allocation',
      component: _components_allocation_allocation_component__WEBPACK_IMPORTED_MODULE_45__["AllocationComponent"],
      canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_35__["AuthGuard"]]
    }, {
      path: 'regulation',
      component: _components_regulation_regulation_component__WEBPACK_IMPORTED_MODULE_46__["RegulationComponent"],
      canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_35__["AuthGuard"]]
    }, {
      path: 'workweek2',
      component: _components_workone_workone_component__WEBPACK_IMPORTED_MODULE_48__["WorkoneComponent"],
      canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_35__["AuthGuard"]]
    }, {
      path: 'workweek3',
      component: _components_worktwo_worktwo_component__WEBPACK_IMPORTED_MODULE_49__["WorktwoComponent"],
      canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_35__["AuthGuard"]]
    }, {
      path: 'surveyone',
      component: _components_surveyone_surveyone_component__WEBPACK_IMPORTED_MODULE_50__["SurveyoneComponent"],
      canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_35__["AuthGuard"]]
    }, {
      path: 'surveytwo',
      component: _components_surveytwo_surveytwo_component__WEBPACK_IMPORTED_MODULE_51__["SurveytwoComponent"],
      canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_35__["AuthGuard"]]
    }, {
      path: 'data',
      component: _components_data_data_component__WEBPACK_IMPORTED_MODULE_53__["DataComponent"],
      canActivate: [_guards_admin_guard__WEBPACK_IMPORTED_MODULE_36__["AdminGuard"]]
    }];
    let AppModule = class AppModule {};
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_7__["AppComponent"], _components_login_login_component__WEBPACK_IMPORTED_MODULE_37__["LoginComponent"], _components_register_register_component__WEBPACK_IMPORTED_MODULE_38__["RegisterComponent"], _components_navbar_navbar_component__WEBPACK_IMPORTED_MODULE_39__["NavbarComponent"], _components_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_40__["DashboardComponent"], _components_admin_admin_component__WEBPACK_IMPORTED_MODULE_41__["AdminComponent"], _components_newpassword_newpassword_component__WEBPACK_IMPORTED_MODULE_42__["NewpasswordComponent"], _components_instructions_instructions_component__WEBPACK_IMPORTED_MODULE_43__["InstructionsComponent"], _components_session_session_component__WEBPACK_IMPORTED_MODULE_44__["SessionComponent"], _components_allocation_allocation_component__WEBPACK_IMPORTED_MODULE_45__["AllocationComponent"], _components_regulation_regulation_component__WEBPACK_IMPORTED_MODULE_46__["RegulationComponent"], _components_work_work_component__WEBPACK_IMPORTED_MODULE_47__["WorkComponent"], _components_workone_workone_component__WEBPACK_IMPORTED_MODULE_48__["WorkoneComponent"], _components_worktwo_worktwo_component__WEBPACK_IMPORTED_MODULE_49__["WorktwoComponent"], _components_surveyone_surveyone_component__WEBPACK_IMPORTED_MODULE_50__["SurveyoneComponent"], _components_surveytwo_surveytwo_component__WEBPACK_IMPORTED_MODULE_51__["SurveytwoComponent"], _components_allocation_info_allocation_info_component__WEBPACK_IMPORTED_MODULE_52__["AllocationInfoComponent"], _components_data_data_component__WEBPACK_IMPORTED_MODULE_53__["DataComponent"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["RouterModule"].forRoot(appRoutes), _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_8__["BrowserAnimationsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientModule"], angular2_flash_messages__WEBPACK_IMPORTED_MODULE_5__["FlashMessagesModule"].forRoot(), _angular_material_button__WEBPACK_IMPORTED_MODULE_9__["MatButtonModule"], _angular_material_progress_spinner__WEBPACK_IMPORTED_MODULE_10__["MatProgressSpinnerModule"], _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_11__["MatSidenavModule"], _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_12__["MatToolbarModule"], _angular_material_list__WEBPACK_IMPORTED_MODULE_13__["MatListModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_14__["MatIconModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_15__["MatCardModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_16__["MatFormFieldModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_17__["MatInputModule"], _angular_material_table__WEBPACK_IMPORTED_MODULE_18__["MatTableModule"], _angular_material_paginator__WEBPACK_IMPORTED_MODULE_19__["MatPaginatorModule"], _angular_material_select__WEBPACK_IMPORTED_MODULE_20__["MatSelectModule"], _angular_material_expansion__WEBPACK_IMPORTED_MODULE_21__["MatExpansionModule"], _angular_material_datepicker__WEBPACK_IMPORTED_MODULE_22__["MatDatepickerModule"], _angular_material_grid_list__WEBPACK_IMPORTED_MODULE_23__["MatGridListModule"], _angular_material_core__WEBPACK_IMPORTED_MODULE_24__["MatNativeDateModule"], _angular_material_tabs__WEBPACK_IMPORTED_MODULE_25__["MatTabsModule"], _angular_material_chips__WEBPACK_IMPORTED_MODULE_26__["MatChipsModule"], _angular_material_radio__WEBPACK_IMPORTED_MODULE_27__["MatRadioModule"], _angular_material_stepper__WEBPACK_IMPORTED_MODULE_28__["MatStepperModule"], _angular_material_button_toggle__WEBPACK_IMPORTED_MODULE_29__["MatButtonToggleModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_30__["MatDialogModule"]],
      providers: [_services_validate_service__WEBPACK_IMPORTED_MODULE_31__["ValidateService"], _services_auth_service__WEBPACK_IMPORTED_MODULE_33__["AuthService"], _services_admin_service__WEBPACK_IMPORTED_MODULE_32__["AdminService"], _services_interaction_service__WEBPACK_IMPORTED_MODULE_34__["InteractionService"], _guards_auth_guard__WEBPACK_IMPORTED_MODULE_35__["AuthGuard"], _guards_admin_guard__WEBPACK_IMPORTED_MODULE_36__["AdminGuard"]],
  ...
  function srcAppComponentsAdminAdminComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let AdminComponent = class AdminComponent {
      constructor(adminService, router, flashMessage) {
          ...
          this.adminService.sendReminder(sendData).subscribe(response => {
            if (response.success) {
              this.flashMessage.show(response.msg, {
                cssClass: 'my-flash-message success-flash',
                timeout: 3000
              });
            } else {
              this.flashMessage.show(response.msg, {
                cssClass: 'my-flash-message alert-flash',
                timeout: 3000
              });
            }
          });
      ...
      getAdminData() {
        this.adminService.getData().subscribe(data => {
          this.displayedColumns = ['session', 'first_name', 'last_name', 'email', 'role', 'register_date', 'instructions', 'allocation1', 'regulation1', 'allocation2', 'regulation2', 'survey1', 'survey2'];
          ...
          if (this.dataview == 'reminder') {
            this.dataSource = this.dataSource.filter(p => {
              let signup_date = moment__WEBPACK_IMPORTED_MODULE_4__(p.register_date, 'YYYY-MM-DD');
              let second_date = moment__WEBPACK_IMPORTED_MODULE_4__(signup_date).add({
                weeks: 1,
                days: p.role == 'worker' ? 1 : 0
              });
              let third_date = moment__WEBPACK_IMPORTED_MODULE_4__(second_date).add(1, 'weeks');
              return this.today.isBetween(second_date, moment__WEBPACK_IMPORTED_MODULE_4__(second_date).add(1, 'days')) || this.today.isBetween(third_date, moment__WEBPACK_IMPORTED_MODULE_4__(third_date).add(1, 'days'));
            });
          }
        });
      }
  ...
  /***/
  function srcAppComponentsAllocationInfoAllocationInfoComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsAllocationInfoAllocationInfoComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AllocationInfoComponent", function () {
    ...
    let AllocationInfoComponent = class AllocationInfoComponent {
      constructor() {}

      ngOnInit() {}

    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], AllocationInfoComponent.prototype, "work_assignment", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], AllocationInfoComponent.prototype, "user", void 0);
    AllocationInfoComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-allocation-info',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./allocation-info.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/components/allocation-info/allocation-info.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./allocation-info.component.css */
      "./src/app/components/allocation-info/allocation-info.component.css")).default]
  ...
  /***/
  function srcAppComponentsAllocationAllocationComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsAllocationAllocationComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AllocationComponent", function () {
    ...
    var _services_interaction_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../../services/interaction.service */
    "./src/app/services/interaction.service.ts");
    /* harmony import */
    ...
    let AllocationComponent = class AllocationComponent {
      constructor(authService, interactionService, flashMessage, router) {
      ...
      ngOnInit() {
        this.authService.getProfile().subscribe(profile => {
          ...
          let tasks = this.user.tasks; // Get allocation number

          let register_date = moment__WEBPACK_IMPORTED_MODULE_7__(this.user.register_date);
          if (moment__WEBPACK_IMPORTED_MODULE_7__(this.current_date).isSame(register_date, 'day')) this.allocation_number = 1;else if (this.user.role == 'regulator' && moment__WEBPACK_IMPORTED_MODULE_7__(this.current_date).isSame(register_date.add(1, 'week'), 'day')) this.allocation_number = 2;else if (this.user.role == 'worker' && moment__WEBPACK_IMPORTED_MODULE_7__(this.current_date).isSame(register_date.add(8, 'days'), 'day')) this.allocation_number = 2;
          ...
          this.getSuggestions(); // Check if open text has been submitted

          if (this.user.tasks.find(e => e.task_tag === 'allocation' + this.allocation_number).completed) this.totally_done = true; // Check if allocation has already been chosen
        ...
        for (let i = 0; i < this.allocation_choices.length; i++) {
          for (let j = 0; j <= 50; j++) {
            ...
            this.allocation_choices[i].w3_options.push((50 - j) * this.allocation_choices[i].exchange_rate); // this.allocation_choices[i].w3_options.push(Math.round( 10*(50-j)/this.allocation_choices[i].exchange_rate)/10 );
          }
        }
      }
      ...
      setDate() {
        this.authService.getProfile().subscribe(profile => {
          this.current_date = moment__WEBPACK_IMPORTED_MODULE_7__(this.picker_date.toISOString());
          this.user = profile.user;
          this.pages_to_complete = this.user.minimal_work;
          let tasks = this.user.tasks; // Get allocation number

          let register_date = moment__WEBPACK_IMPORTED_MODULE_7__(this.user.register_date);
          if (moment__WEBPACK_IMPORTED_MODULE_7__(this.current_date).isSame(register_date, 'day')) this.allocation_number = 1;else if (this.user.role == 'regulator' && moment__WEBPACK_IMPORTED_MODULE_7__(this.current_date).isSame(register_date.add(1, 'week'), 'day')) this.allocation_number = 2;else if (this.user.role == 'worker' && moment__WEBPACK_IMPORTED_MODULE_7__(this.current_date).isSame(register_date.add(8, 'days'), 'day')) this.allocation_number = 2; // Check if open text has been submitted
        ...
        this.getUser(() => {
          if (this.user && this.user.extra_allocation_info) {
            this.allocation_choices.forEach(choice => {
              let canvas = document.getElementById(choice.chartId);
                  ...
                  legend: {
                    labels: {
                      generateLabels: function generateLabels() {
                        return [{
                          text: 'Week 2',
                          fillStyle: 'rgba(102,107,104,1)'
                        }, {
                          text: 'Week 3',
                          fillStyle: 'rgba(196,199,209,1)'
                        }];
                      }
                    }
                  },
      ...
      checkIfDone() {
        if (this.work_completed == this.pages_to_complete) {
          this.flashMessage.show('Work completed', {
            cssClass: 'my-flash-message success-flash',
            timeout: 5000
          });
          this.selected_tab = 1;
      ...
      submitAllocation() {
        ...
        this.interactionService.registerChoice('allocation' + this.allocation_number, submit_choices).subscribe(res => {
          if (res.success) {
            ...
            this.selected_tab = 2;
            this.allocation_done = true; // this.router.navigate(['/dashboard']);
          } else {
            this.flashMessage.show(res.msg, {
              cssClass: 'my-flash-message alert-flash',
              timeout: 5000
    ...
    AllocationComponent.ctorParameters = () => [{
    ...
    AllocationComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-allocation',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./allocation.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/components/allocation/allocation.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./allocation.component.css */
      "./src/app/components/allocation/allocation.component.css")).default]
    })], AllocationComponent);
    /***/
  },
  ...
  function srcAppComponentsDashboardDashboardComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_services_interaction_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! src/app/services/interaction.service */
    "./src/app/services/interaction.service.ts");

    let DashboardComponent = class DashboardComponent {
      constructor(breakpointObserver, authService, router, interactionsService) {
        ...
        this.worker_cards = [{
          ...
          title: 'Instructions',
          week: 1,
          text: 'Read the instructions and answer the control questions correctly.'
        }, {
          tag: 'survey1',
          title: 'Survey 1',
          week: 1,
          ...
          title: 'Allocation 1',
          week: 1,
          text: 'Choose an allocation of work'
        }, {
          tag: 'allocation2',
          title: 'Allocation 2',
          week: 2,
          ...
          title: 'Work 1',
          week: 2,
          text: 'Complete work by moving sliders to 50'
        }, {
          tag: 'work2',
          title: 'Work 2',
          week: 3,
        ...
        this.regulator_cards = [{
          ...
          title: 'Regulation 1',
          week: 1,
          text: "Choose your prefered regulation of the worker's choices"
        }, {
          tag: 'allocation2',
          title: 'Allocation 2',
          week: 2,
        ...
        this.columns = 2;
        this.alignment = this.breakpointObserver.observe(_angular_cdk_layout__WEBPACK_IMPORTED_MODULE_3__["Breakpoints"].Handset).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(({
          matches
        }) => {
          if (matches) {
            this.columns = 1;
      ...
      checkWork() {
        ...
        this.work1_active = this.cards.find(e => e.tag === 'work1').active;
        this.work2_active = this.cards.find(e => e.tag === 'work2').active; // this.work_completed = this.cards[this.cards.map(e=>e.tag).indexOf('work1')].active;
      ...
      setCards() {
        let w1_begin = moment__WEBPACK_IMPORTED_MODULE_5__(this.user.register_date, 'YYYY-MM-DD');
        let w2_begin = moment__WEBPACK_IMPORTED_MODULE_5__(w1_begin.format()).add({
          weeks: 1,
          days: this.user.role == 'worker' ? 1 : 0
        });
        let w3_begin = moment__WEBPACK_IMPORTED_MODULE_5__(w2_begin).add(1, 'weeks');
  ...
  /***/
  function srcAppComponentsDataDataComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsDataDataComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    let DataComponent = class DataComponent {
        ...
        this.adminService.getData().subscribe(data => {
          ...
          for (let i = 0; i < data.length; i++) {
            for (let j = 0; j < data[i].instructionreports.length; j++) {
              this.data.push("".concat(data[i]._id, "; ").concat(data[i].instructionreports[j].time, "; ").concat(data[i].instructionreports[j].report[0], "; ").concat(data[i].instructionreports[j].report[1], "; ").concat(data[i].instructionreports[j].report[2]) + "; ".concat(data[i].instructionreports[j].report[3], "; ").concat(data[i].instructionreports[j].report[4], "; ").concat(data[i].instructionreports[j].report[5], "; ").concat(data[i].instructionreports[j].report[6]) + "; ".concat(data[i].instructionreports[j].report[7], "; ").concat(data[i].instructionreports[j].report[8], "; ").concat(data[i].instructionreports[j].report[9]));
            }
          }
        });
      }
        ...
        this.adminService.getData().subscribe(data => {
          ...
          for (let i = 0; i < data.length; i++) {
            for (let j = 0; j < data[i].timestamps.length; j++) {
              this.data.push("".concat(data[i]._id, "; ").concat(data[i].timestamps[j].stamp_tag, "; ").concat(data[i].timestamps[j].time));
            }
          }
        });
      }
      ...
      displayPaymentData() {
        this.adminService.getData().subscribe(data => {
          ...
          for (let i = 1; i < 3; i++) {
            this.datahead += "; reg".concat(i, ".choice1; reg").concat(i, ".choice2; reg").concat(i, ".choice3; reg").concat(i, ".choice4; reg").concat(i, ".choice5") + "; reg".concat(i, ".c1.below0; reg").concat(i, ".c1.below10; reg").concat(i, ".c1.below20; reg").concat(i, ".c1.below30; reg").concat(i, ".c1.below40; reg").concat(i, ".c1.below50") + "; reg".concat(i, ".c2.below0; reg").concat(i, ".c2.below10; reg").concat(i, ".c2.below20; reg").concat(i, ".c2.below30; reg").concat(i, ".c2.below40; reg").concat(i, ".c2.below50");
          }

          this.data = [];

          for (let i = 0; i < data.length; i++) {
            this.data.push("".concat(data[i]._id, "; ").concat(data[i].group_id, "; ").concat(data[i].session, "; ").concat(data[i].first_name, "; ").concat(data[i].last_name, "; ").concat(data[i].email, "; ").concat(data[i].role, "; ").concat(data[i].payoffweek));
            ...
            if (survey2.completed) {
              ...
              this.data[i] += "; ".concat(payment.answer, "; ").concat(payment.regnum, "; ").concat(payment.accnum, "; ").concat(payment.phonenum);
            } else {
              this.data[i] += "; .; .; .; .";
            }

            this.data[i] += "; ".concat(data[i].tasks.find(e => e.task_tag == 'instructions').completed ? 'true' : 'false', "; ").concat(data[i].tasks.find(e => e.task_tag == 'allocation1').completed ? 'true' : 'false') + "; ".concat(data[i].tasks.find(e => e.task_tag == 'allocation2').completed ? 'true' : 'false', "; ").concat(data[i].tasks.find(e => e.task_tag == 'work1').completed ? 'true' : 'false') + "; ".concat(data[i].tasks.find(e => e.task_tag == 'work2').completed ? 'true' : 'false', "; ").concat(data[i].tasks.find(e => e.task_tag == 'survey1').completed ? 'true' : 'false') + "; ".concat(data[i].tasks.find(e => e.task_tag == 'survey2').completed ? 'true' : 'false');

            if (this.data[i].role == 'regulator') {
              this.data[i] += "; ".concat(data[i].tasks.find(e => e.task_tag == 'regulation1').completed ? 'true' : 'false', "; ").concat(data[i].tasks.find(e => e.task_tag == 'regulation2').completed ? 'true' : 'false');
            } else {
              this.data[i] += "; .; .";
            }
            ...
            if (survey1.completed) {
              this.data[i] += "; ".concat(survey1.answers.find(e => e.name === 'risk').answer, "; ").concat(survey1.bombplacement);
            } else {
              this.data[i] += '; .; .';
            } // Regulation 1 & 2
            ...
            if (reg_payoffweek && reg_payoffweek.completed) {
              this.data[i] += "; ".concat(reg_payoffweek.payoffchoice);
            } else {
              this.data[i] += "; .";
            }
            ...
            for (let j = 1; j < 3; j++) {
              ...
              if (regulation && regulation.completed == true) {
                ...
                this.data[i] += "; ".concat(part1.choices[0], "; ").concat(part1.choices[1], "; ").concat(part1.choices[2], "; ").concat(part1.choices[3], "; ").concat(part1.choices[4], "; ").concat(part1.suggestions.min[0], "; ").concat(part1.suggestions.min[1], "; ").concat(part1.suggestions.min[2], "; ").concat(part1.suggestions.min[3], "; ").concat(part1.suggestions.min[4]);
                let part3 = regulation.parts[2];
                this.data[i] += "; ".concat(part3.choices[0][0].input, "; ").concat(part3.choices[0][1].input, "; ").concat(part3.choices[0][2].input, "; ").concat(part3.choices[0][3].input, "; ").concat(part3.choices[0][4].input, "; ").concat(part3.choices[0][5].input) + "; ".concat(part3.choices[1][0].input, "; ").concat(part3.choices[1][1].input, "; ").concat(part3.choices[1][2].input, "; ").concat(part3.choices[1][3].input, "; ").concat(part3.choices[1][4].input, "; ").concat(part3.choices[1][5].input);
              } else {
                let add = "";
      ...
      displayUserData() {
        this.adminService.getData().subscribe(data => {
          ...
          this.datahead = "id; first_name; last_name; kuid; email; register_date; session; role; group_id; extra_allocation_info"; // Survey 1

          this.datahead += "; birthyear; country; hometype; interestrate; highinteretexp; highinterestpayment; height; weight; smoking; drinking; risk"; // Survey 2

          this.datahead += "; gender; faculty; field; leftright; equalincomes; publicownership; responsibility; compitition; hardwork; zerosum; prohibitsugar; taxsugar; hidesugar" + "; prohibitalcohol; taxalcohol; hidealcohol; prohibittobacco; taxtobacco; hidetobacco; reginterests; vote"; // Allocation 1+2

          for (let i = 1; i < 3; i++) {
            this.datahead += "; allocation".concat(i, ".choice1; allocation").concat(i, ".choice2; allocation").concat(i, ".choice3; allocation").concat(i, ".choice4; allocation").concat(i, ".choice5; allocation").concat(i, ".freetext");
          } // Regulation 1+2


          for (let i = 1; i < 3; i++) {
            this.datahead += "; reg".concat(i, ".choice1; reg").concat(i, ".choice2; reg").concat(i, ".choice3; reg").concat(i, ".choice4; reg").concat(i, ".choice5") + "; reg".concat(i, ".suggest1; reg").concat(i, ".suggest2; reg").concat(i, ".suggest3; reg").concat(i, ".suggest4; reg").concat(i, ".suggest5") + "; reg".concat(i, ".c1.optimala; reg").concat(i, ".c1.optimalb; reg").concat(i, ".c1.optimalc; reg").concat(i, ".c1.optimald; reg").concat(i, ".c1.optimale; reg").concat(i, ".c1.optimalf") + "; reg".concat(i, ".c2.optimala; reg").concat(i, ".c2.optimalb; reg").concat(i, ".c2.optimalc; reg").concat(i, ".c2.optimald; reg").concat(i, ".c2.optimale; reg").concat(i, ".c2.optimalf") + "; reg".concat(i, ".c1.below0; reg").concat(i, ".c1.below10; reg").concat(i, ".c1.below20; reg").concat(i, ".c1.below30; reg").concat(i, ".c1.below40; reg").concat(i, ".c1.below50") + "; reg".concat(i, ".c2.below0; reg").concat(i, ".c2.below10; reg").concat(i, ".c2.below20; reg").concat(i, ".c2.below30; reg").concat(i, ".c2.below40; reg").concat(i, ".c2.below50") + "; reg".concat(i, ".sentiment; reg").concat(i, ".free_text; reg").concat(i, ".help; reg").concat(i, ".harm");
          } // work 1 & 2


          for (let i = 1; i < 3; i++) {
            this.datahead += "; work".concat(i, ".sentiment_before; work").concat(i, ".sentiment_after");
          }

          for (let i = 0; i < data.length; i++) {
            let par = data[i]; // User data

            this.data.push("".concat(par._id, "; ").concat(par.first_name, "; ").concat(par.last_name, "; ").concat(par.ku_id, "; ").concat(par.email, "; ").concat(par.register_date, "; ").concat(par.session, "; ").concat(par.role, "; ") + "".concat(par.group_id, "; ").concat(par.extra_allocation_info)); // Survey 1 data

            let survey1 = par.tasks[par.tasks.map(e => e.task_tag).indexOf('survey1')];

            if (survey1 && survey1.completed == true) {
              survey1 = survey1.answers;
              this.data[i] += "; ".concat(survey1[0].answer, "; ").concat(survey1[1].answer, "; ").concat(survey1[2].answer, "; ").concat(survey1[3].answer, "; ").concat(survey1[4].answer, "; ").concat(survey1[5].answer) + "; ".concat(survey1[6].answer, "; ").concat(survey1[7].answer, "; ").concat(survey1[8].answer, "; ").concat(survey1[9].answer, "; ").concat(survey1[10].answer);
            } else {
              this.data[i] += '; .; .; .; .; .; .; .; .; .; .; .';
            } // Survey 2 data
            ...
            if (survey2 && survey2.completed == true) {
              ...
              this.data[i] += "; ".concat(survey2[0].answer, "; ").concat(survey2[1].answer, "; ").concat(survey2[2].answer, "; ").concat(survey2[3].answer, "; ").concat(survey2[4].answer, "; ").concat(survey2[5].answer) + "; ".concat(survey2[6].answer, "; ").concat(survey2[7].answer, "; ").concat(survey2[8].answer, "; ").concat(survey2[9].answer, "; ").concat(survey2[10].answer, "; ").concat(survey2[11].answer) + "; ".concat(survey2[12].answer, "; ").concat(survey2[13].answer, "; ").concat(survey2[14].answer, "; ").concat(survey2[15].answer, "; ").concat(survey2[16].answer, "; ").concat(survey2[17].answer) + "; ".concat(survey2[18].answer, "; ").concat(survey2[19].answer, "; ").concat(survey2[20].answer);
            } else {
              this.data[i] += "; .; .; .; .; .; .; .; .; .; .; .; .; .; .; .; .; .; .; .; .; .";
            } // Allocation 1 & 2
            ...
            for (let j = 1; j < 3; j++) {
              ...
              if (allocation && allocation.completed == true) {
                this.data[i] += "; ".concat(allocation.allocation[0].choice, "; ").concat(allocation.allocation[1].choice, "; ").concat(allocation.allocation[2].choice, "; ").concat(allocation.allocation[3].choice, "; ").concat(allocation.allocation[4].choice);
              } else {
                this.data[i] += "; .; .; .; .; .";
              }

              this.data[i] = allocation.free_text ? this.data[i] + "; ".concat(allocation.free_text) : this.data[i] + "; .";
            } // Regulation 1 & 2
            ...
            for (let j = 1; j < 3; j++) {
              ...
              if (regulation && regulation.completed == true) {
                ...
                this.data[i] += "; ".concat(part2.choices[0][0].input, "; ").concat(part2.choices[0][1].input, "; ").concat(part2.choices[0][2].input, "; ").concat(part2.choices[0][3].input, "; ").concat(part2.choices[0][4].input, "; ").concat(part2.choices[0][5].input) + "; ".concat(part2.choices[1][0].input, "; ").concat(part2.choices[1][1].input, "; ").concat(part2.choices[1][2].input, "; ").concat(part2.choices[1][3].input, "; ").concat(part2.choices[1][4].input, "; ").concat(part2.choices[1][5].input);
                let part3 = regulation.parts[2];
                this.data[i] += "; ".concat(part3.choices[0][0].input, "; ").concat(part3.choices[0][1].input, "; ").concat(part3.choices[0][2].input, "; ").concat(part3.choices[0][3].input, "; ").concat(part3.choices[0][4].input, "; ").concat(part3.choices[0][5].input) + "; ".concat(part3.choices[1][0].input, "; ").concat(part3.choices[1][1].input, "; ").concat(part3.choices[1][2].input, "; ").concat(part3.choices[1][3].input, "; ").concat(part3.choices[1][4].input, "; ").concat(part3.choices[1][5].input);
                let part4 = regulation.parts[3];
                this.data[i] += "; ".concat(part4.choices[0].sentiment, "; ").concat(part4.choices[0].free_text, "; ").concat(part4.choices[0].help, "; ").concat(part4.choices[0].harm);
              } else {
                let add = "";
            ...
            for (let j = 1; j < 3; j++) {
              ...
              if (work && work.completed == true) {
                this.data[i] += "; ".concat(work.sentiment_before, "; ").concat(work.sentiment_after);
              } else {
                this.data[i] += '; .; .';
              }
            }
    ...
    DataComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-data',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./data.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/components/data/data.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./data.component.css */
      "./src/app/components/data/data.component.css")).default]
    })], DataComponent);
    /***/
  },
  ...
  function srcAppComponentsInstructionsInstructionsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_services_interaction_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! src/app/services/interaction.service */
    "./src/app/services/interaction.service.ts");

    let InstructionsComponent = class InstructionsComponent {
      constructor(authService, router, flashMessage, interactionService) {
        this.authService = authService;
        this.router = router;
        this.flashMessage = flashMessage;
        this.interactionService = interactionService;
      ...
      ngOnInit() {
        this.authService.getProfile().subscribe(profile => {
          ...
          let w1 = moment__WEBPACK_IMPORTED_MODULE_5__(this.user.register_date, 'YYYY-MM-DD');
          let w2 = moment__WEBPACK_IMPORTED_MODULE_5__(w1.format()).add({
            weeks: 1,
            days: this.user.role == 'worker' ? 1 : 0
          });
          let w3 = moment__WEBPACK_IMPORTED_MODULE_5__(w2).add(1, 'weeks');
          this.complete_dates = [w1.format("dddd, MMMM Do"), w2.format("dddd, MMMM Do"), w3.format("dddd, MMMM Do")];
          this.correct_answers = ['3', '1 day', this.user.role == 'regulator' ? '1 week' : '1 week and 1 day', 'regoneother', 'regbyoneother', this.user.role, "week12", "week2", "14", "36", "50", "0"];
        });
      }
          ...
          if (failed) {
            this.interactionService.instructionsReport(this.user, this.answers_check).subscribe(res => {
              if (res.success) {
                ...
                this.flashMessage.show('You have incorrect answers', {
                  cssClass: 'my-flash-message alert-flash',
                  timeout: 3000
                });
              }
            ...
            this.authService.completeControl(this.user).subscribe(response => {
              if (response.success) {
                this.flashMessage.show('Instructions completed', {
                  cssClass: 'my-flash-message success-flash',
                  timeout: 3000
                });
                this.router.navigate(['/dashboard']);
  ...
  function srcAppComponentsLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let LoginComponent = class LoginComponent {
      constructor(authService, validateService, router, flashMessage) {
        this.authService = authService;
      ...
      loginSubmit() {
        if (!this.email || this.email.length == 0) {
          this.flashMessage.show('Please put in a valid email adress', {
            cssClass: 'my-flash-message alert-flash',
            timeout: 5000
          });
        } else if (!this.password || this.password.length == 0) {
          this.flashMessage.show('Please put in a password', {
            cssClass: 'my-flash-message alert-flash',
            timeout: 5000
          });
        } else {
      ...
      resetPassword() {
        if (!this.email || this.email.length == 0) {
          this.flashMessage.show('Please write in your email address', {
            cssClass: 'my-flash-message alert-flash',
            timeout: 3000
          });
        } else if (!this.validateService.validateEmail(this.email)) {
          this.flashMessage.show('Please input a valid email', {
            cssClass: 'my-flash-message alert-flash',
            timeout: 3000
          });
          return false;
  ...
  function srcAppComponentsNavbarNavbarComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let NavbarComponent = class NavbarComponent {
      constructor(breakpointObserver, router, flashMessage, authService) {
        this.breakpointObserver = breakpointObserver;
        this.router = router;
        this.flashMessage = flashMessage;
        this.authService = authService;
        this.isHandset$ = this.breakpointObserver.observe(_angular_cdk_layout__WEBPACK_IMPORTED_MODULE_5__["Breakpoints"].Handset).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(result => result.matches));
      }
  ...
  /***/
  function srcAppComponentsNewpasswordNewpasswordComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsNewpasswordNewpasswordComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    let NewpasswordComponent = class NewpasswordComponent {
      constructor(router, flashMessage, authService) {
        this.router = router;
        this.flashMessage = flashMessage;
        this.authService = authService;
      }
      ...
      resetpassword() {
        if (!this.newpassword1 || !this.newpassword2 || this.newpassword1.length == 0 || this.newpassword2.length == 0) {
          this.flashMessage.show('Please input a new password', {
            cssClass: 'my-flash-message alert-flash',
            timeout: 3000
          });
    ...
    NewpasswordComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./newpassword.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/components/newpassword/newpassword.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./newpassword.component.css */
      "./src/app/components/newpassword/newpassword.component.css")).default]
  ...
  function srcAppComponentsRegisterRegisterComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let RegisterComponent = class RegisterComponent {
      constructor(validateService, authService, adminService, flashMessage, router) {
        this.validateService = validateService;
        this.authService = authService;
        this.adminService = adminService;
        this.flashMessage = flashMessage;
      ...
      register() {
        ...
        if (this.email != this.email2) {
          this.flashMessage.show('The email adresses do not match', {
            cssClass: 'my-flash-message alert-flash',
            timeout: 3000
          });
          return false;
        ...
        if (this.password != this.password2) {
          this.flashMessage.show('The passwords do not match', {
            cssClass: 'my-flash-message alert-flash',
            timeout: 3000
          });
          return false;
        ...
        this.authService.registerUser(user).subscribe(response => {
          if (response.success) {
            this.flashMessage.show('You have now been registered', {
              cssClass: 'my-flash-message success-flash',
              timeout: 3000
            });
            this.router.navigate(['/login']);
  ...
  /***/
  function srcAppComponentsRegulationRegulationComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsRegulationRegulationComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "RegulationComponent", function () {
    ...
    var chartjs_plugin_annotation__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! chartjs-plugin-annotation */
    "./node_modules/chartjs-plugin-annotation/src/index.js");
    /* harmony import */


    var chartjs_plugin_annotation__WEBPACK_IMPORTED_MODULE_7___default =
    /*#__PURE__*/
    __webpack_require__.n(chartjs_plugin_annotation__WEBPACK_IMPORTED_MODULE_7__);
    /* harmony import */
    ...
    let RegulationComponent = class RegulationComponent {
      constructor(authService, interactionService, flashMessage, router) {
        this.authService = authService;
        this.interactionService = interactionService;
        this.flashMessage = flashMessage;
        ...
        this.belief_colors = ['#c7e9b4', '#7fcdbb', '#41b6c4', '#1d91c0', '#225ea8', '#253494', '#081d58']; // belief_colors = ['#1f77b4','#ff7f0e','#2ca02c','#d62728','#9467bd','#8c564b','#e377c2']
        ...
        this.optimal_choices = [{
          ...
          choiceCharts: [{}, {}, {}, {}, {}, {}],
          choices: [],
          chartId: ["optimal00", "optimal01", "optimal02", "optimal03", "optimal04", "optimal05"]
        }, {
          name: 'Choice 2',
          exchange_rate: 1.25,
          w2_options: [],
          ...
          choiceCharts: [{}, {}, {}, {}, {}, {}],
          choices: [],
          chartId: ["optimal10", "optimal11", "optimal12", "optimal13", "optimal14", "optimal15"]
        }];
        this.distribution_choices = [{
          ...
          beliefs_calculated: [],
          chartId: ["d01", "d02", "d03", "d04", "d05", "d06"]
        }, {
          name: 'Choice 2',
          exchange_rate: 1.25,
          w2_options: [],
          ...
          distribution_beliefs: [],
          beliefs_calculated: [],
          chartId: ["d11", "d12", "d13", "d14", "d15", "d16"]
        }];
        this.belief_done = [false, false];
      }

      ngOnInit() {
        let namedChartAnnotation = chartjs_plugin_annotation__WEBPACK_IMPORTED_MODULE_7__;
        namedChartAnnotation["id"] = "annotation";
        chart_js__WEBPACK_IMPORTED_MODULE_6__["Chart"].pluginService.register(namedChartAnnotation); // Check if we are in week 2 or week 3 or not at any valid date

        this.authService.getProfile().subscribe(response => {
          this.user = response.user;
          let register_date = moment__WEBPACK_IMPORTED_MODULE_8__(this.user.register_date);

          if (moment__WEBPACK_IMPORTED_MODULE_8__(this.current_date).isSame(register_date, 'day')) {
            this.week = 1;
          } else if (this.current_date.isSame(register_date.add({
            weeks: 1
          }), 'day')) {
            this.week = 2;
          } else {
          ...
          if (this.week) {
            ...
            this.optimal_choices.forEach((choice, i) => {
              ...
              for (let i = 0; i < this.sub_names.length; i++) {
                choice.choices.push({
                  name: this.sub_names[i],
                  input: null,
                  worker_w2_choice: i * 10,
                  worker_w3_choice: Math.round(10 * (50 - i * 10) * choice.exchange_rate) / 10,
                  selected: false
            ...
            this.distribution_choices.forEach((choice, i) => {
              ...
              for (let i = 0; i < this.beliefs.length; i++) {
                choice.distribution_beliefs.push({
                  name: this.beliefs[i],
                  input: null,
                  min: 0
                });
              ...
              for (let i = 0; i < this.calc_beliefs.length; i++) {
                choice.beliefs_calculated.push({
                  name: this.calc_beliefs[i],
                  value: 0
                });
              }
            });
      ...
      setDate() {
        ...
        let register_date = moment__WEBPACK_IMPORTED_MODULE_8__(this.user.register_date).hours(0);
      ...
      navigate() {
        if (this.task.parts && this.task.parts[3]) {
          this.totally_completed = true; // this.router.navigate(['/dashboard'])
      ...
      optimalCharts() {
        this.optimal_choices.forEach((choice, index) => {
          choice.choiceCharts.forEach((chart, chart_index) => {
            ...
            colors_w2.reverse();
            colors_w3.reverse();
            let canvas = document.getElementById(choice.chartId[chart_index]);
            let ctx = canvas.getContext('2d');
            choice.choiceCharts[chart_index] = new chart_js__WEBPACK_IMPORTED_MODULE_6__["Chart"](ctx, {
              type: 'bar',
              data: {
                labels: choice.w2_options,
                datasets: [{
                  label: "Week 2",
                  data: [...choice.w2_options].reverse(),
                  backgroundColor: colors_w2,
                  borderColor: 'black'
                }, {
                  label: "Week 3",
                  data: [...choice.w3_options].reverse(),
                  backgroundColor: colors_w3,
                  borderColor: 'black'
                }]
              },
              options: {
      ...
      beliefCharts() {
        this.distribution_choices.forEach((choice, index) => {
          choice.choiceCharts.forEach((chart, chart_index) => {
            ...
            let canvas = document.getElementById(choice.chartId[chart_index]);
            let ctx = canvas.getContext('2d');
            chart = new chart_js__WEBPACK_IMPORTED_MODULE_6__["Chart"](ctx, {
              type: 'bar',
              data: {
                labels: choice.w2_options,
                datasets: [{
                  label: "Week 2",
                  data: [...choice.w2_options].reverse(),
                  backgroundColor: colorsW2,
                  borderWidth: border,
                  borderColor: "black"
                }, {
                  label: "Week 3",
                  data: [...choice.w3_options].reverse(),
                  backgroundColor: colorsW3,
                  borderWidth: border,
                  borderColor: "black"
                }]
              },
      ...
      updateDistribution(input_no) {
        ...
        this.distribution_choices[input_no].beliefs_calculated.forEach((belief, index) => {
          if (index == 0) belief.value = distribution[0].input != null ? distribution[0].input : 0;else if (index == 6) belief.value = 100 - Math.max(...distribution.map(e => e.input));else if (distribution[index].input != null) {
        ...
        if (beliefs[belief_index].value + amount >= 0 && beliefs[belief_index].value + amount <= 100) {
          ...
          if (beliefs.map(e => e.value).reduce((t, n) => t + n) == 100) {
            ...
            dist_beliefs.forEach((dist, index) => {
              if (index == 0) dist.input = beliefs[0].value;else {
                dist.input = beliefs.slice(0, index + 1).map(e => e.value).reduce((t, n) => t + n); // Update minimums
    ...
    RegulationComponent.ctorParameters = () => [{
      type: _services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"]
    }, {
      type: _services_interaction_service__WEBPACK_IMPORTED_MODULE_3__["InteractionService"]
    }, {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material_stepper__WEBPACK_IMPORTED_MODULE_9__["MatStepper"], {
      static: true
    })], RegulationComponent.prototype, "stepper", void 0);
    RegulationComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-regulation',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./regulation.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/components/regulation/regulation.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./regulation.component.css */
      "./src/app/components/regulation/regulation.component.css")).default]
    })], RegulationComponent);
    /***/
  },
  ...
  /***/
  function srcAppComponentsSessionSessionComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppComponentsSessionSessionComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let SessionComponent = class SessionComponent {
      constructor(adminService, flashMessage) {
        this.adminService = adminService;
        this.flashMessage = flashMessage;
        this.displayedColumns = ['session', 'first_name', 'last_name', 'email', 'role', 'register_date', 'instructions', 'allocation1', 'regulation1', 'allocation2', 'regulation2', 'survey1', 'survey2'];
        this.dataSource = [];
      ...
      deleteSession() {
        if (this.deletepassword === null) this.deletepassword = '';else {
          this.adminService.deleteSession(this.deletepassword, this.session_number).subscribe(res => {
            this.flashMessage.show(res.msg, {
              cssClass: "my-flash-message ".concat(res.success ? 'success' : 'alert', "-flash"),
              timeout: 3000
            });
          });
        }
      ...
      sessionChange() {
        ...
        this.userData(); // getSessionData() retrieves the participation codes
        ...
        this.adminService.getData().subscribe(data => {
          if (data) {
            data = data.filter(function (item) {
              return item.session == angular.session_number;
            });
            this.user_data = data;
      ...
      createSession() {
        ...
        if (confirm('Are you ready to start the session?')) {
          ...
          if (this.participants_count == undefined) {
            this.flashMessage.show('Please fill in the amount of participants', {
              cssClass: 'my-flash-message alert-flash',
              timeout: 3000
            });
            return false;
          ...
          if (+this.participants_count < +this.ku_students) {
            this.flashMessage.show('The number of KU students exceeds the number of participants', {
              cssClass: 'my-flash-message alert-flash',
              timeout: 3000
            });
            return false;
          ...
          if (this.participants_count % 2 != 0) {
            this.flashMessage.show('There must be an even number of participants', {
              cssClass: 'my-flash-message alert-flash',
              timeout: 3000
            });
            return false;
          ...
          this.adminService.createSession(session).subscribe(response => {
            if (response.success) {
              this.getSessionData();
              this.flashMessage.show('Session created', {
                cssClass: 'my-flash-message success-flash',
                timeout: 3000
              });
            } else {
    ...
    SessionComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/components/session/session.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./session.component.css */
      "./src/app/components/session/session.component.css")).default]
    })], SessionComponent);
    /***/
  },
  ...
  /***/
  function srcAppComponentsSurveyoneSurveyoneComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsSurveyoneSurveyoneComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SurveyoneComponent", function () {
    ...
    let SurveyoneComponent = class SurveyoneComponent {
      ...
      ngOnInit() {
        this.authService.getProfile().subscribe(profile => {
          ...
          let register_date = moment__WEBPACK_IMPORTED_MODULE_5__(this.user.register_date);
          if (!moment__WEBPACK_IMPORTED_MODULE_5__(this.current_date).isSame(register_date.add({
            weeks: this.user.role == 'regulator' ? 2 : 0
          }), 'day')) this.router.navigate(['/dashboard']);
        });
      }
      ...
      validateChoices(callback) {
        this.choices.forEach((choice, index) => {
          this.choices_check[index] = choice == null ? 'Please answer this question' : true;
        });
        ...
        let validated = this.choices_check.every(e => e === true);
        callback(validated);
      }
      ...
      completeSurvey() {
        this.validateChoices(validated => {
          if (validated) {
            let submit_choices = [];
            ...
            this.authService.completeSurvey(this.user, '1', submit_choices).subscribe(response => {
              if (response.success) {
                this.flashMessage.show('Survey completed', {
                  cssClass: 'my-flash-message success-flash',
                  timeout: 3000
                });
                this.router.navigate(['/dashboard']);
            ...
            let problem_index = this.choices_check.findIndex(e => e != null && e != true);
            ...
            document.getElementsByClassName('mat-sidenav-content')[0].scrollTo(0, 0);
            this.flashMessage.show('Some of your answers are invalid', {
              cssClass: 'my-flash-message alert-flash',
              timeout: 3000
            });
          }
    ...
    SurveyoneComponent.ctorParameters = () => [{
      type: _services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"]
    }, {
      type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]
    }, {
    ...
    SurveyoneComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-surveyone',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./surveyone.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/components/surveyone/surveyone.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./surveyone.component.css */
      "./src/app/components/surveyone/surveyone.component.css")).default]
    })], SurveyoneComponent);
    /***/
  },
  ...
  /***/
  function srcAppComponentsSurveytwoSurveytwoComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsSurveytwoSurveytwoComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SurveytwoComponent", function () {
    ...
    let SurveytwoComponent = class SurveytwoComponent {
      constructor(authService, router, flashMessage) {
        this.authService = authService;
        this.router = router;
        this.flashMessage = flashMessage;
        ...
        this.current_date = moment__WEBPACK_IMPORTED_MODULE_5__();
        this.party_options = [{
          txt: "Socialdemokratiet (A)",
          val: "A"
        }, {
          txt: "Radikale Venstre (B)",
          val: 'B'
        }, {
          txt: "Det Konservative Folkeparti (C)",
          val: "C"
        }, {
          txt: "Nye Borgerlige (D)",
          val: "D"
        }, {
          txt: "Klaus Riskær Pedersen (E)",
          val: "E"
        }, {
          txt: "SF- Socialistisk Folkeparti (F)",
          val: "F"
        }, {
          txt: "Liberal Alliance (I)",
          val: "I"
        }, {
          txt: "Kristendemokraterne (K)",
          val: "K"
        }, {
          txt: "Dansk Folkeparti (O)",
          val: "O"
        }, {
          txt: "Stramp Kurs (P)",
          val: "P"
          ...
          txt: "I am not allowed to vote in Denmark",
          val: "nonvoter"
        }];
        this.five_scale = ['Very good', 'Good', 'Neither good nor bad', 'Bad', 'Very bad'];
        this.numbers = [...Array(8).keys()].map(e => {
          return {
            val: (e + 2).toString(),
            txt: (e + 2).toString()
          };
        });
        this.regulation_options = [...Array(5).keys()].map(e => {
          return {
            val: (e + 1).toString(),
            txt: "".concat(e + 1, " ").concat(this.five_scale[e])
          };
        });
        this.questions = [{
          name: "gender",
          ...
          name: "faculty",
          text: "Which faculty do you study at?",
          ...
          name: "leftright",
          text: "In political matters, people talk of 'the left' and 'the right'. How would you place your views on this scale, generally speaking?",
          options: [{
            val: '1',
            txt: "Left"
          }].concat(this.numbers).concat([{
            val: '10',
            txt: 'Right'
          }]),
          answer: null,
          ...
          name: "equalincomes",
          text: "How would you place your views on this scale?",
          options: [{
            val: '1',
            txt: 'Incomes should be made more equal'
          }].concat(this.numbers).concat({
            val: '10',
            txt: 'We need larger income differences as incentives for individual effort'
          }),
          answer: null,
          check: null
        }, {
          name: "publicownership",
          text: "How would you place your views on this scale?",
          options: [{
            val: '1',
            txt: 'Private ownership of business and industry should be increased'
          }].concat(this.numbers).concat({
            val: '10',
            txt: 'Government ownership of business and industry should be increased'
          }),
          answer: null,
          check: null
        }, {
          ...
          options: [{
            val: '1',
            txt: 'Governement should take more responsibility to ensure that everyone is provided for'
          }].concat(this.numbers).concat({
            val: '10',
            txt: 'People should take more responsibility to provide for themselves'
          }),
          answer: null,
          check: null
        }, {
          ...
          options: [{
            val: '1',
            txt: 'Competition is good. It stimulates people to work hard and develop new ideas'
          }].concat(this.numbers).concat({
            val: '10',
            txt: 'Compitition is harmful. It brings out the worst in people'
          }),
          answer: null,
          check: null
        }, {
          ...
          options: [{
            val: '1',
            txt: 'In the long run, hard work usually brings a better life'
          }].concat(this.numbers).concat({
            val: '10',
            txt: "Hard work doesn't generally bring success-it's more a matter of luck and connections"
          }),
          answer: null,
          check: null
        }, {
          ...
          options: [{
            val: '1',
            txt: "People can only get rich at the expense of others"
          }].concat(this.numbers).concat({
            val: '10',
            txt: "Wealth can grow so there's enough for everyone"
          }),
          answer: null,
          check: null
        }, {
          name: "regsugar",
          title: "Regulation of high-sugar beverages",
          tag: "high-sugar beverages",
          options: this.regulation_options,
          prohibit_answer: null,
          prohibit_check: null,
          tax_answer: null,
          tax_check: null,
          hide_answer: null,
          hide_check: null,
          text: "Several countries around the world levy taxes on beverages with high sugar content (which is associated with obsesity).",
          tax_question: " What is your attitude towards a tax that would increase the price of sugary beverages in Norway by 20%?"
        }, {
          name: "regalcohol",
          title: "Regulation of alcoholic beverages",
          ...
          hide_answer: null,
          hide_check: null,
          tax_question: "What is your attitude towards a tax that would increase the price of alcoholic beverages in Norway by 50%?"
        }, {
          name: "regtobacco",
          ...
          hide_answer: null,
          hide_check: null,
          tax_queston: "What is your attitude towards a tax that would increase the price of cigarettes by 50% in Norway?"
        }, {
          name: "reginterests",
          title: "Regulation of high-interest loans",
          tag: "high-interest loans",
          options: this.regulation_options,
          answer: null,
          check: null,
          text: 'There is a political discussion about the regulation of short-term, high-interest loans also known as "payday loans" or "kviklån". Setting a cap on interest rates may help some people not take out loans, which it is in their best interest not to take out. On the other hand, setting a cap may hinder some individuals in taking out a loan which they need.',
          question: "What is your attitude towards setting a maximum of 20% interest on a loan in Norway?"
        }, {
          name: "vote",
          title: "Vote",
          options: this.party_options,
          answer: null,
          check: null
        }, {
          name: "jobsector",
          text: "Imagine that you have attained your academic degree and are free to choose between jobs.",
          answer: null,
          check: null,
          options: [{
            val: "private",
          ...
          question: "Where would you prefer to get a job?"
        }, {
          name: "paymentmethod",
          answer: null,
          check: null,
      ...
      validateChoices(callback) {
        ...
        this.questions.forEach((question, index) => {
          if (index >= this.questions.map(e => e.name).indexOf("regsugar") && index < this.questions.map(e => e.name).indexOf("reginterests")) {
            choices_check.push(question.prohibit_answer == null ? false : {
              name: question.name,
              answer: question.prohibit_answer
            });
            this.questions[index].prohibit_check = question.prohibit_answer == null ? 'Please answer this question' : true;
            choices_check.push(question.tax_answer == null ? false : {
              name: question.name,
              answer: question.tax_answer
            });
            this.questions[index].tax_check = question.tax_answer == null ? 'Please answer this question' : true;
            choices_check.push(question.hide_answer == null ? false : {
              name: question.name,
              answer: question.hide_answer
            });
            this.questions[index].hide_check = question.hide_answer == null ? 'Please answer this question' : true;
          } else {
            choices_check.push(question.answer == null ? false : {
              name: question.name,
        ...
        if (payment.answer == 'transfer' && (!payment.regnum || !payment.accnum)) {
          ...
          choices_check[choices_check.length - 1] = {
            name: payment.name,
            answer: payment.answer,
            regnum: payment.regnum,
            accnum: payment.accnum,
            phonenum: payment.phonenum
          };
        }

        let validated = choices_check.every(e => {
      ...
      completeSurvey() {
        this.validateChoices((validated, choices_check) => {
          if (validated) {
    ...
    SurveytwoComponent.ctorParameters = () => [{
      type: _services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"]
    }, {
      type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]
    }, {
    ...
    SurveytwoComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-surveytwo',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./surveytwo.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/components/surveytwo/surveytwo.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./surveytwo.component.css */
      "./src/app/components/surveytwo/surveytwo.component.css")).default]
    })], SurveytwoComponent);
    /***/
  },
  ...
  function srcAppComponentsWorkWorkComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_interaction_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../../services/interaction.service */
    "./src/app/services/interaction.service.ts");
    /* harmony import */
    ...
    /*! rxjs/operators */
    "./node_modules/rxjs/_esm2015/operators/index.js"); // import { EventEmitter } from 'protractor';


    let WorkComponent = class WorkComponent {
      constructor(breakpointObserver, interactionService) {
        this.breakpointObserver = breakpointObserver;
        this.interactionService = interactionService;
        this.pageDoneEvent = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"](); // ranges_per_page = 20;

        this.ranges = [];
        this.maxOffset = 20;
        this.isHandset$ = this.breakpointObserver.observe(_angular_cdk_layout__WEBPACK_IMPORTED_MODULE_3__["Breakpoints"].Handset).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(result => result.matches));
      } // @Input() ranges_per_page:number;


      set ranges_per_page(ranges_per_page) {
      ...
      spacePress(event) {
        event.preventDefault(); // Focus first non-completed range
      ...
      setRanges() {
        ...
        for (let i = 0; i < this.range_num; i++) {
          this.ranges.push({
            value: 0,
            margin: Math.random() * this.maxOffset,
            id: i
          });
        }
      }
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], WorkComponent.prototype, "target", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], WorkComponent.prototype, "completed", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()], WorkComponent.prototype, "pageDoneEvent", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], WorkComponent.prototype, "ranges_per_page", null);
  ...
  /***/
  function srcAppComponentsWorkoneWorkoneComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsWorkoneWorkoneComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "WorkoneComponent", function () {
    ...
    let WorkoneComponent = class WorkoneComponent {
      constructor(authService, interactionService, flashMessage, router) {
        this.authService = authService;
        this.interactionService = interactionService;
        this.flashMessage = flashMessage;
        ...
        this.selected_tab = 0;
        this.current_date = moment__WEBPACK_IMPORTED_MODULE_6__(); // allocation_done:boolean = false;
        // min_work_done:boolean = false;

        this.work_done = false;
        this.range_number = 16; // min_work_completed:number = 0;
      ...
      ngOnInit() {
        this.getUser(() => {
          ...
          let register_date = moment__WEBPACK_IMPORTED_MODULE_6__(this.user.register_date);
          if (moment__WEBPACK_IMPORTED_MODULE_6__(this.current_date).isSame(register_date.add({
            weeks: 1,
            days: this.user.role == 'worker' ? 1 : 0
          }), 'day')) this.right_date = true;else {
            this.right_date = false;
            this.router.navigate(['/dashboard']);
          }
          let tasks = this.user.tasks;
    ...
    WorkoneComponent.ctorParameters = () => [{
      type: _services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"]
    }, {
      type: _services_interaction_service__WEBPACK_IMPORTED_MODULE_3__["InteractionService"]
    }, {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material_stepper__WEBPACK_IMPORTED_MODULE_7__["MatStepper"], {
      static: true
    })], WorkoneComponent.prototype, "stepper", void 0);
    WorkoneComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-workone',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./workone.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/components/workone/workone.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./workone.component.css */
      "./src/app/components/workone/workone.component.css")).default]
    })], WorkoneComponent);
    /***/
  },
  ...
  /***/
  function srcAppComponentsWorktwoWorktwoComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsWorktwoWorktwoComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "WorktwoComponent", function () {
    ...
    let WorktwoComponent = class WorktwoComponent {
      constructor(authService, interactionService, flashMessage, router) {
        this.authService = authService;
        this.interactionService = interactionService;
        this.flashMessage = flashMessage;
    ...
    WorktwoComponent.ctorParameters = () => [{
      type: _services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"]
    }, {
      type: _services_interaction_service__WEBPACK_IMPORTED_MODULE_3__["InteractionService"]
    }, {
    ...
    WorktwoComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-worktwo',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./worktwo.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/components/worktwo/worktwo.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./worktwo.component.css */
      "./src/app/components/worktwo/worktwo.component.css")).default]
    })], WorktwoComponent);
    /***/
  },
  ...
  function srcAppGuardsAdminGuardTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let AdminGuard = class AdminGuard {
      constructor(authService, router, adminService) {
        this.authService = authService;
        this.router = router;
        this.adminService = adminService;
      }
  ...
  function srcAppServicesAdminServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let AdminService = class AdminService {
      ...
      createSession(session) {
        this.loadToken();
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().append('Content-Type', 'application/json').append('Authorization', this.authToken);
        return this.http.post('admin/session', session, {
          headers: headers
        });
      }
      ...
      beginSession(session_number) {
        this.loadToken();
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().append('Content-Type', 'application/json').append('Authorization', this.authToken);
        return this.http.post('admin/sessionbegin', {
      ...
      getSessions() {
        this.loadToken();
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().append('Content-Type', 'application/json').append('Authorization', this.authToken);
        return this.http.get('admin/session', {
          headers: headers
        });
      } // Load token
      ...
      deleteSession(password, sessionnum) {
        ...
        if (JSON.parse(localStorage.getItem('user')).admin) {
          return this.http.post('admin/deletesession', {
            password,
            sessionnum
          }, {
            headers: headers
      ...
      sendReminder(info) {
        this.loadToken();
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().append('Content-Type', 'application/json').append('Authorization', this.authToken);
        return this.http.post('admin/sendreminder', info, {
          headers: headers
        });
      }
  ...
  function srcAppServicesAuthServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let AuthService = class AuthService {
      ...
      isAdmin() {
        if (JSON.parse(localStorage.user).admin) return true;else return false;
      }
      ...
      completeSurvey(user, num, choices) {
        this.loadToken();
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().append('Content-Type', 'application/json').append('Authorization', this.authToken);
        return this.http.post('users/completesurvey', {
          user: user,
          surveynum: num,
          choices
        }, {
      ...
      resetPassword(email) {
        return this.http.post('users/resetpassword', {
          email
        });
      }

      newPassword(password, resetcode) {
        return this.http.post('users/newpassword', {
          password,
          resetcode
        });
      }
  ...
  function srcAppServicesInteractionServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let InteractionService = class InteractionService {
      ...
      registerWork(task_tag, work_completed) {
        let task_info = {
          tag: task_tag,
        ...
        this.loadToken();
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().append('Content-Type', 'application/json').append('Authorization', this.authToken);
        return this.http.post('users/registerwork', task_info, {
          headers: headers
        });
      }

      registerSentiment(task_tag, type, sentiment) {
        this.loadToken();
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().append('Content-Type', 'application/json').append('Authorization', this.authToken);
        return this.http.post('users/sentiment', {
          task_tag,
          type,
          sentiment
        }, {
      ...
      registerMinWork(task_tag, work_completed) {
        let task_info = {
          tag: task_tag,
          completed: work_completed
        };
      ...
      registerChoice(allocation_tag, choices) {
        let choice_info = {
          tag: allocation_tag,
          choices: choices
        };
        this.loadToken();
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().append('Content-Type', 'application/json').append('Authorization', this.authToken);
        return this.http.post('users/registerChoice', choice_info, {
          headers: headers
        });
      }

      registerAllocationText(allocation_tag, text) {
        let choice_info = {
          tag: allocation_tag,
          text: text
        };
        this.loadToken();
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().append('Content-Type', 'application/json').append('Authorization', this.authToken);
        return this.http.post('users/registerAllocationText', choice_info, {
          headers: headers
        });
      }

      registerRegChoice(submit) {
        this.loadToken();
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().append('Content-Type', 'application/json').append('Authorization', this.authToken);
        return this.http.post('users/registerregchoice', submit, {
          headers: headers
        });
      }
      ...
      instructionsReport(user, report) {
        this.loadToken();
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().append('Content-Type', 'application/json').append('Authorization', this.authToken);
        return this.http.post('users/instructionsreport', {
          user,
          report
        }, {
          headers: headers
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\App projects\Experiments\Temporal choice regulation\deploy\angular-src\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
