...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"container\">\n\n  <h1 class=\"main-heading\">Work week 2</h1>\n\n  <mat-horizontal-stepper color=\"warn\" [linear]=\"true\" #stepper>\n\n    <mat-step editable=\"false\" label=\"Step 1\" completed=\"false\">\n      <app-allocation-info [work_assignment]=\"work_assignment\" [user]=\"user\"></app-allocation-info>\n      <div class=\"input-container\" style=\"text-align:left;margin-top:20px\">\n        <label id=\"sentiment_before\">How staisfied are you with this allocation?</label>\n        <mat-radio-group color=\"primary\" aria-labelledby=\"sentimentradio\" [(ngModel)]=\"sentiment_before\" style=\"display:flex;flex-direction:column;margin:15px 0;\">\n          <mat-radio-button value=\"0\" style=\"margin:5px;\">0 Very unsatisfied</mat-radio-button>\n          <mat-radio-button value=\"1\" style=\"margin:5px;\">1</mat-radio-button>\n          <mat-radio-button value=\"2\" style=\"margin:5px;\">2</mat-radio-button>\n          <mat-radio-button value=\"3\" style=\"margin:5px;\">3</mat-radio-button>\n          <mat-radio-button value=\"4\" style=\"margin:5px;\">4</mat-radio-button>\n          <mat-radio-button value=\"5\" style=\"margin:5px;\">5 Very satisfied</mat-radio-button>\n        </mat-radio-group>\n      </div>\n      <div class=\"button-box\" style=\"text-align:left;\">\n        <p>Please complete all choices in order to move forward in the experiment.</p>\n        <button [disabled]=\"sentiment_before==null\" class=\"active-button\" mat-raised-button (click)=\"submit(0)\">Submit</button>\n      </div>\n    </mat-step>\n\n    <mat-step editable=\"false\" label=\"Step 2\" completed=\"false\">\n      <app-work *ngIf=\"!work_done\" [target]=\"pages_to_complete\" [completed]=\"work_completed\" [ranges_per_page]=\"range_number\" (pageDoneEvent)=\"addWork()\"></app-work>\n    </mat-step>\n\n    <mat-step editable=\"false\" label=\"Step 3\" completed=\"false\">\n      <div style=\"text-align: initial;\">\n        <app-allocation-info [work_assignment]=\"work_assignment\" [user]=\"user\"></app-allocation-info>\n        <div class=\"input-container\" style=\"text-align:left;margin-top:20px\">\n          <label id=\"sentiment\">How staisfied are you with this allocation?</label>\n          <mat-radio-group color=\"primary\" aria-labelledby=\"sentimentradio\" [(ngModel)]=\"sentiment_after\" style=\"display:flex;flex-direction:column;margin:15px 0;\">\n            <mat-radio-button value=\"0\" style=\"margin:5px;\">0 Very unsatisfied</mat-radio-button>\n            <mat-radio-button value=\"1\" style=\"margin:5px;\">1</mat-radio-button>\n            <mat-radio-button value=\"2\" style=\"margin:5px;\">2</mat-radio-button>\n            <mat-radio-button value=\"3\" style=\"margin:5px;\">3</mat-radio-button>\n            <mat-radio-button value=\"4\" style=\"margin:5px;\">4</mat-radio-button>\n            <mat-radio-button value=\"5\" style=\"margin:5px;\">5 Very satisfied</mat-radio-button>\n          </mat-radio-group>\n        </div>\n        <div class=\"button-box\" style=\"text-align:left;\">\n          <p>Please complete all choices in order to move forward in the experiment.</p>\n          <button [disabled]=\"sentiment_after==null\" class=\"active-button\" mat-raised-button (click)=\"submit(2)\">Submit</button>\n        </div>\n      </div>\n    </mat-step>\n  </mat-horizontal-stepper>\n</div>\n");
...
var AllocationComponent = /** @class */ (function () {
    ...
    AllocationComponent.prototype.userReady = function () {
        var _this = this;
        ...
        var register_date = moment__WEBPACK_IMPORTED_MODULE_7__(this.user.register_date);
        if (moment__WEBPACK_IMPORTED_MODULE_7__(this.current_date).isSame(register_date, 'day'))
            this.allocation_number = 1;
        else if (this.user.role == 'regulator' && moment__WEBPACK_IMPORTED_MODULE_7__(this.current_date).isSame(register_date.add(1, 'week'), 'day'))
            this.allocation_number = 2;
        else if (this.user.role == 'worker' && moment__WEBPACK_IMPORTED_MODULE_7__(this.current_date).isSame(register_date.add(8, 'days'), 'day'))
            this.allocation_number = 2;
        if (this.allocation_number === null) {
            this.router.navigate(['/dahsboard']);
        }
        // Get suggestions for workers
        this.getSuggestions();
        // Check if open text has been submitted
        if (this.user.tasks.find(function (e) { return e.task_tag === 'allocation' + _this.allocation_number; }).completed)
            this.totally_done = true;
        // Check if allocation has already been chosen
        else if (this.user.tasks.find(function (e) { return e.task_tag === 'allocation' + _this.allocation_number; }).allocation) {
            this.work_done = true;
            this.allocation_done = true;
            this.selected_tab = 2;
        }
        else if (this.allocation_number && tasks.find(function (e) { return e.task_tag === 'allocation' + _this.allocation_number; }).work_completed) {
            this.work_completed = tasks.find(function (e) { return e.task_tag === 'allocation' + _this.allocation_number; }).work_completed;
            this.checkIfDone();
        }
    };
...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent.prototype.userReady = function () {
        if (this.user.work_assignment && (this.user.role != 'regulator' || this.user.tasks.find(function (e) { return e.task_tag === 'regulation2'; }).completed)) {
        ...
        this.adminService.getData().subscribe(function (data) {
            ...
            var _loop_1 = function (i) {
                ...
                if (data[i].role === "regulator" && reg_payoffweek && reg_payoffweek.completed) {
                    var regulation = data[i].tasks.find(function (e) { return e.task_tag === "regulation" + data[i].payoffweek; });
                    var dist_payoffchoice = regulation.parts[2].choices[Math.floor(reg_payoffweek.payoffchoice / 6)][reg_payoffweek.payoffchoice - Math.floor(reg_payoffweek.payoffchoice / 6) * 6];
                    _this.data[i] += "; " + dist_payoffchoice.name + "; " + dist_payoffchoice.input + "; " + regulation.parts[3].choices[0].help + "; " + regulation.parts[3].choices[0].harm;
                }
                else {
                    _this.data[i] += "; .; .";
                }
...
var InstructionsComponent = /** @class */ (function () {
    ...
    InstructionsComponent.prototype.userReady = function () {
        var tasks = this.user.tasks;
        this.control_completed = tasks[tasks.map(function (e) { return e.task_tag; }).indexOf('instructions')].completed ? true : false;
        var w1 = moment__WEBPACK_IMPORTED_MODULE_5__(this.user.register_date, 'YYYY-MM-DD');
        var w2 = moment__WEBPACK_IMPORTED_MODULE_5__(w1.format()).add({ weeks: 1, days: this.user.role == 'worker' ? 1 : 0 });
...
var RegulationComponent = /** @class */ (function () {
    ...
    RegulationComponent.prototype.userReady = function () {
        var _this = this;
        ...
        var register_date = moment__WEBPACK_IMPORTED_MODULE_8__(this.user.register_date);
        ...
        if (this.week) {
            ...
            this.optimal_choices.forEach(function (choice, i) {
...
var SurveyoneComponent = /** @class */ (function () {
    ...
    SurveyoneComponent.prototype.userReady = function () {
        var tasks = this.user.tasks;
        this.survey_completed = tasks[tasks.map(function (e) { return e.task_tag; }).indexOf('survey1')].completed ? true : false;
        var register_date = moment__WEBPACK_IMPORTED_MODULE_5__(this.user.register_date);
        if (!moment__WEBPACK_IMPORTED_MODULE_5__(this.current_date).isSame(register_date.add({ weeks: this.user.role == 'regulator' ? 2 : 0 }), 'day'))
            this.router.navigate(['/dashboard']);
    };
...
var SurveytwoComponent = /** @class */ (function () {
    ...
    SurveytwoComponent.prototype.userReady = function () {
        if (typeof this.user == "string") {
            this.user = JSON.parse(this.user);
        }
        else if (!this.user) {
        ...
        var tasks = this.user.tasks;
        this.survey_completed = tasks[tasks.map(function (e) { return e.task_tag; }).indexOf('survey2')].completed ? true : false;
        var register_date = moment__WEBPACK_IMPORTED_MODULE_5__(this.user.register_date);
        if (!moment__WEBPACK_IMPORTED_MODULE_5__(this.current_date).isSame(register_date.add({ weeks: 2 }), 'day'))
            this.router.navigate(['/dashboard']);
    };
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.getProfile = function () {
        ...
        return this.http.post('users/profile', user);
    };
    ...
    AuthService.prototype.completeControl = function (user) {
        this.loadToken();
        // let headers = new HttpHeaders().append('Content-Type','application/json').append('Authorization',this.authToken)
        return this.http.post('users/completeinstructions', user);
    };
    AuthService.prototype.completeSurvey = function (user, num, choices) {
        this.loadToken();
        // let headers = new HttpHeaders().append('Content-Type','application/json').append('Authorization',this.authToken)
        return this.http.post('users/completesurvey', { user: user, surveynum: num, choices: choices });
    };
...
var InteractionService = /** @class */ (function () {
    ...
    InteractionService.prototype.registerWork = function (task_tag, work_completed) {
        ...
        this.loadToken();
        // let headers = new HttpHeaders().append('Content-Type','application/json').append('Authorization',this.authToken)
        return this.http.post('users/registerwork', { task_info: task_info, user: user });
    };
    InteractionService.prototype.registerSentiment = function (task_tag, type, sentiment) {
        this.loadToken();
        var user = JSON.parse(localStorage.getItem('user'));
        // let headers = new HttpHeaders().append('Content-Type','application/json').append('Authorization',this.authToken)
        return this.http.post('users/sentiment', { task_tag: task_tag, type: type, sentiment: sentiment, user: user });
    };
    ...
    InteractionService.prototype.registerChoice = function (allocation_tag, choices) {
        ...
        this.loadToken();
        // let headers = new HttpHeaders().append('Content-Type','application/json').append('Authorization',this.authToken)
        return this.http.post('users/registerChoice', { choice_info: choice_info, user: user });
    };
