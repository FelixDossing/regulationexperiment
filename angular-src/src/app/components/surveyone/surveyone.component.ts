...
@Component({
  ...
  templateUrl: './surveyone.component.html',
  styleUrls: ['./surveyone.component.css']
})
export class SurveyoneComponent implements OnInit {
  ...
  completeSurvey() {
    this.validateChoices((validated:boolean) => {
      if (validated) {
        let submit_choices = [];
